...
import {ToastrcustomService} from '../dashboard-module/ShareComponent/toastrcustom/toastrcustom';
...
export class HttpClientInterceptor implements HttpInterceptor {
  ...
  AddTokenheader(request: HttpRequest<any>) {
    ...
    this.check = false;
    return request.clone({setHeaders: {Authorization: 'Bearer ' + userInfo.access_token}});
  }
}
